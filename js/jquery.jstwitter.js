$(function() {		
	...
	JQTWEET = {
	    ...
	    template: '<li class="slide"><span class="holder"><span class="tweet-wrapper"><h5 class="text">{TEXT}</h5>\
	               <h6><span class="time"><a href="{URL}" target="_blank">{AGO}</a></span>\
	               by <span class="user">{USER}</span></span></h6></span></li>',
	    ...
	    loadTweets: function(params) {
	       ...
	       var defaults = $.extend({}, {			
			...
			JQTWEET.numTweets = defaults.numTweets;
	            ...
	            success: function(data, textStatus, xhr) {
	                ...
	                try {
	                  ...
	                  //item is less than item count
						...
						var flexs = $("body").find(".flex_slideshow_tweet");
						if(flexs.length > 0){
							flexs.addClass("flexslider");
							var aniTyp = flexs.hasClass('slideAnimation') ? "slide" : "fade";
							flexs.flexslider({
								slideshow: false,
								animation: aniTyp,
								slideshowSpeed: 5000
