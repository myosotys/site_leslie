...
(function( $ ){	
	...
	function detailPage(selector, params){
		...
		var defaults = $.extend({}, { 
			...
			self.proDetPos = 0;			
			self.posIt = false;
			self.backPage  = $("body").find(".projDetailLoad");
...
// Close projDetailLoad div
		closeBackCon : function(){
			...
			setTimeout(function(){ $("body").mainFm('scroll_update',0);  },1000);
